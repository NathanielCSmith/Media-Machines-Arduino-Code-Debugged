...
Adafruit_DotStar team01LEDstrip = Adafruit_DotStar(144, DATA_REDTEAM, CLOCK_REDTEAM,  DOTSTAR_BRG); //WS2801 LED Strip for Team 01 (side with power port) //assign var data pin & clock pin
Adafruit_DotStar team02LEDstrip = Adafruit_DotStar(144, DATA_BLUETEAM, CLOCK_BLUETEAM, DOTSTAR_BRG); //WS2801 LED Strip for Team 02 (side without power port) //assign var data pin & clock pin

// LEDS
const int team01LeftButtonLED = 12; //Left is top button
const int team01RightButtonLED = 11; //Right button is bottom button
const int team02LeftButtonLED = 10;
const int team02RightButtonLED = 9;
...
boolean bluestrip2animating = false;
boolean bluestrip3animating = false;
boolean bluestrip4animating = false;

boolean redstrip1animating = false;
boolean redstrip2animating = false;
boolean redstrip3animating = false;
boolean redstrip4animating = false;
...
StripAnimation red1(&team01LEDstrip, 0, 35, 0xFF0000, 0xFF0099);
StripAnimation red2(&team01LEDstrip, 36, 36 + 35, 0xFF0000, 0xFF0099);
StripAnimation red3(&team01LEDstrip, 72, 72 + 35, 0xFF0000, 0xFF0099);
StripAnimation red4(&team01LEDstrip, 98, 98 + 35, 0xFF0000, 0xFF0099);

StripAnimation blue1(&team02LEDstrip, 0, 35, 0x0000FF, 0x9900FF);
StripAnimation blue2(&team02LEDstrip, 36, 36 + 35, 0x0000FF, 0x9900FF);
StripAnimation blue3(&team02LEDstrip, 72, 72 + 35, 0x0000FF, 0x9900FF);
StripAnimation blue4(&team02LEDstrip, 98, 98 + 35, 0x0000FF, 0x9900FF);
